...
class _ChatPageState extends State<ChatPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   children: [
      //     ChatWindowCard(
      //       avatar: 'https://www.mocas.icu/image/108.jpg',
      //       uname: '人鱼公主纱耶香',
      //       message: '你死哪儿去啦？',
      //       counter: 3,
      //       dtime: '19:40',
      //     ),
      //     ChatWindowCard(
      //       avatar: 'https://www.mocas.icu/image/874.jpg',
      //       uname: '教导主任',
      //       message: '你在干嘛呢？来趟办公室！',
      //       counter: 0,
      //       dtime: '昨天 09:05',
      //     ),
      //     ChatWindowCard(
      //       avatar: 'https://www.mocas.icu/image/387.jpg',
      //       uname: '沙卡拉卡',
      //       message: '气死我了，今天好倒霉奥~',
      //       counter: 0,
      //       dtime: '上周',
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              return _LastMsgWidget(
                ...
                username: '魔咔啦咔',
                avatarURL: 'https://www.mocas.icu/image/874.jpg',
