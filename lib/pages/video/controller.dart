...
class VideoController extends GetxController {
  ...
  final data = <VideoModel>[
    VideoModel(
      uid: 12,
      username: '哈喽',
      avatar: 'https://www.mocas.icu/image/452.jpg',
      cid: 52,
    ...
    VideoModel(
      uid: 12,
      username: '去玩啊',
      avatar: 'https://www.mocas.icu/image/52.jpg',
      cid: 52,
      cLogo: 'https://www.mocas.icu/image/45.jpg',
      vid: '2',
      cover: 'cover',
    ...
    VideoModel(
      uid: 12,
      username: '搜打发',
      avatar: 'https://www.mocas.icu/image/75.jpg',
      cid: 52,
      cLogo: 'https://www.mocas.icu/image/45.jpg',
      vid: '3',
      cover: 'cover',
    ...
    VideoModel(
      uid: 12,
      username: '搜打发',
      avatar: 'https://www.mocas.icu/image/851.jpg',
      cid: 52,
