...
class RoutesNamespace {
  ...
  /// 视频收藏列表页
  static const ProfileVideoCollect = '/profile/video/collect';

  /// 视频发布列表页
  static const ProfileVideoPublish = '/profile/video/publish';

  /// 消息收藏列表页
  static const ProfileEventCollect = '/profile/event/collect';
